...
-- 2022-11-18,MOrr,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_MOrr')
	 Begin 
	  Alter Database [Assignment06DB_MOrr] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_MOrr;
	 End
	Create Database Assignment06DB_MOrr;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_MOrr;
...
Create View vInventoriesByProductByDate
As
	Select Top 1000
		p.ProductName, 
		i.InventoryDate, 
...
Create View vInventoriesByProductByCategory
As
	Select Top 1000
		c.CategoryName, 
		p.ProductName, 
...
Create View vChaiAndChangInventoriesByEmployee
As
	Select Top 1000
		c.CategoryName, 
		p.ProductName, 
...
Create View vInventoriesByProductByCategoryByEmployee
As
	Select Top 1000
		c.CategoryID,
		c.CategoryName,
		...
		Concat(mgr.EmployeeFirstName, ' ', mgr.EmployeeLastName) As EmployeeManager
	From vCategories As c 
		Join vProducts As p 
			On c.CategoryID = p.CategoryID
		Join vInventories As i 
...
Select * From dbo.vInventoriesByProductByDate;
Select * From dbo.vInventoryDatesByEmployee;
Select * From dbo.vInventoriesByProductByCategory;
Select * From dbo.vInventoriesByProductByEmployee;
Select * From dbo.vChaiAndChangInventoriesByEmployee;
Select * From dbo.vEmployeesByManager;
Select * From dbo.vInventoriesByProductByCategoryByEmployee;
